...
export default function Footer() {
    ...
    return (
        <footer className="bg-black text-white px-6 md:px-20 py-20">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
                <div className="md:col-span-6 space-y-8">
                    <h3 className="text-sm text-neutral-500 mb-4 uppercase tracking-widest font-manrope">Get in touch</h3>
                    <Link
                        href="mailto:abina5448@gmail.com"
                        className="inline-flex items-center gap-3 text-3xl md:text-5xl font-bold font-syne hover:text-neutral-400 transition-colors tracking-tighter"
                    >
                        abina5448@gmail.com
                    </Link>
                </div>
                ...
                <div className="md:col-span-3 md:col-start-8 space-y-8">
                    <div>
                        <h3 className="text-sm text-neutral-500 mb-4 uppercase tracking-widest font-manrope">Socials</h3>
                        <div className="flex flex-col gap-3 font-manrope text-lg">
                ...
                <div className="md:col-span-3 space-y-8">
                    <div>
                        <h3 className="text-sm text-neutral-500 mb-4 uppercase tracking-widest font-manrope">Sitemap</h3>
                        <div className="flex flex-col gap-3 font-manrope text-lg">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/10 text-neutral-500 text-sm font-manrope">
